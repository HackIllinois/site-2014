...
from AdminHandler import AdminHandler, AdminApproveHandler, AdminResumeHandler, AdminStatsHandler, AdminBasicStatsHandler, AdminXkcdHandler, AdminProfileHandler, AdminEditProfileHandler
...
handlers = [
    ...
    RedirectRoute('/signupcount', handler=SignupCountHandler, name='SignupCount', strict_slash=True),
