...
sendgrid_template_name = '[Do Not Send - Template] HackIllinois Application Acceptance'

# This must be created already in the SendGrid account
sendgrid_identity = 'contact@hackillinois.org'
sendgrid_marketing_name = 'HackIllinois Application Acceptance [DATETIME]'
sendgrid_list_name = 'HackIllinois Application Acceptance [DATETIME]'
...
def send_email(marketing_email_name):
    print 'Sending email...'
    req = sendgrid_req('/schedule/add.json', data={
        'name': marketing_email_name
    })
