...
RSVP_CLOSED_MESSAGE = 'We\'re sorry, but your RSVP deadline for HackIllinois has past.<br>We may have released your spot to another hacker on the waitlist. <br><a href="mailto:contact@hackillinois.org" style="color: #ef3e36">Email us</a> to see if there\'s still space available. Happy hacking!'
